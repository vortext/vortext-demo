(ns vortext.flake
  "From Skuld https://github.com/Factual/skuld/blob/master/src/skuld/flake.clj
  Inspired by http://boundary.com/blog/2012/01/12/flake-a-decentralized-k-ordered-unique-id-generator-in-erlang/
...
(defn ^String url-safe-id
  "Generates a new flakeID; encoded as a url safe base64 string"
  []
  (Base64/encodeBase64URLSafeString (id)))
