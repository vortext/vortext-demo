...
Finally, the EBM demo uses robotreviewer2, which depends on large models. This requires the use and initialisation of git-lfs to manage the large files in the repository

  brew install git-lfs
  cd <your folder>
  git-lfs install
  cd <your folder>/resources/topologies/ebm/robotreviewer2
  git lfs pull # this triggers 1 GB download of models!
